...
(deftest setup-projection-plane
  (let [camera (p/point 0 0 10)
        focus  (p/point 0 0  0)
        up     (p/point 0 1  0)
        plane (projection/projection-plane camera focus up)]
    (is (= (p/point  0 0   0) (:p1 plane)))
    (is (= (p/point  0 1   0) (:p2 plane)))
    (is (= (p/point 10 0   0) (:p3 plane)))
    (is (= (p/point  0 0 -10) (:n plane)))))
