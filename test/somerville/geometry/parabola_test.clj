...
(deftest beachlines
  (let [beachline1 (par/beachline (list (par/parabola-from-factors 1 0 0) (par/parabola-from-factors 1 0 1)))
    ...
    (is (= (par/get-parabola-from-beachline beachline4 (- (p/x (nth (:intersections beachline4) 0)) 1)) beach-4-parabola-2))
    (is (= (par/get-parabola-from-beachline beachline4 (+ (p/x (nth (:intersections beachline4) 0)) 1)) beach-4-parabola-1))
    (is (= (par/get-parabola-from-beachline beachline4 (- (p/x (nth (:intersections beachline4) 1)) 1)) beach-4-parabola-1))
    (is (= (par/get-parabola-from-beachline beachline4 (+ (p/x (nth (:intersections beachline4) 1)) 1)) beach-4-parabola-2))
